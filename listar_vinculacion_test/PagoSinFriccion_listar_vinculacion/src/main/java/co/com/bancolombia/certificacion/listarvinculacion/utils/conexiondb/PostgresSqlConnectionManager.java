...
import co.com.bancolombia.certificacion.listarvinculacion.utils.Constantes;
...
public class PostgresSqlConnectionManager {
    ...
    public PostgresSqlConnectionManager() {
    }
    ...
    public static Connection getConnection() {
        ...
        try {
            if (null == dataSource) {
                dbProp = PropertiesManager.getDbProperties(Constantes.POSTGRES_QL);
