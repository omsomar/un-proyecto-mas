...
public class GeneradorArchivosJSON {
    ...
    public static void convertirMapaAArchivo(List<Map<String, Map<String, Object>>> mapa, String fileName) throws IOException {
        Gson gson = new Gson();
        File file = new File(RUTA_ARCHIVO_PROPERTIES + CARPETA_ARCHIVO + fileName);

        List<Map<String, Map<String, Object>>> mapList = new ArrayList<>();
        if (!file.exists()) {
            for (Map<String, Map<String, Object>> data : mapa) {
                mapList.add(data);
            }
    ...
    public static List<Map<String, Map<String,Object>>> readFileToListOfMapWithMap(String fileName) throws IOException {
        File file = new File(RUTA_ARCHIVO_PROPERTIES + CARPETA_ARCHIVO + fileName);
        Reader reader = Files.newReader(file, Charset.defaultCharset());
        List<Map<String, Map<String, Object>>> result = new Gson().fromJson(reader, new TypeToken<List<Map<String, Map<String,Object>>>>() {
        }.getType());
        reader.close();
        return result;
    }
