...
import co.com.bancolombia.certificacion.consultarvinculacion.utils.Convertir;
...
public class ValidacionInformacionListarVinculacion implements Question<Boolean> {
    ...
    public static ValidacionInformacionListarVinculacion validacion() {
        return new ValidacionInformacionListarVinculacion();
    }
}
